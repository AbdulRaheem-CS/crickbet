...
interface GameLauncherProps {
  gameUrl?: string; // Made optional as we might have content instead
  gameContent?: string;
  gameName: string;
  onClose: () => void;
}

export default function GameLauncher({ gameUrl, gameContent, gameName, onClose }: GameLauncherProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black flex flex-col">
      ...
      <div className="flex-1 relative">
        ...
        {/* If we have direct HTML content, use srcDoc, otherwise use src */}
        <iframe
