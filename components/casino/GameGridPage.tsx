...
function GameGridContent({
  ...
  const [launchContent, setLaunchContent] = useState<string | null>(null);
  ...
  return (
    <>
      ...
      {(launchUrl || launchContent) && (
        <GameLauncher
          gameUrl={launchUrl || undefined}
          gameContent={launchContent || undefined}
          gameName={launchName}
          onClose={() => {
            setLaunchUrl(null);
            setLaunchContent(null);
            setLaunchName('');
          }}
        />
      )}
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-0.5">
              <button
                ...
                className={`p-2 rounded-md transition ${gridSize === 'normal' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500'
                  }`}
                title="Small grid"
              >
              ...
              <button
                ...
                className={`p-2 rounded-md transition ${gridSize === 'large' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500'
                  }`}
                title="Large grid"
              >
                    ...
                    {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-9 h-9 rounded-lg text-sm font-medium transition ${page === pageNum
